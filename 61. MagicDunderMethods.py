# __init__ method
# The init method is a special method that is automatically invoked when you
# create a new instance of a class. This method is responsible for setting up
# the object’s initial state, and it is where you would typically define any
...
# pass it as a parameter to a function and it will be executed when the
# function is called. This is an incredibly powerful tool that allows you to
